...
class Monitor():
    ...
    def no_coches_norte(self):
        return self.dentro_norte.value==0
    
    def no_coches_sur (self):
        return self.dentro_sur.value==0
    
    def no_peaton (self):
        return self.dentro_peaton.value==0
    ...
    def wants_enter_car(self, direction: int) -> None:
        ...
        if direction==SOUTH: 
            ...
            self.abierto_sur.wait_for(self.no_coches_norte) and self.abierto_sur.wait_for(self.no_peaton)
            #self.nodentro_sur.wait_for(self.no_coches_sur)
            self.dentro_sur.value+=1
            self.cars_south.value-=1     
        if direction==NORTH:
            self.cars_north.value+=1
            self.abierto_norte.wait_for(self.no_coches_sur) and self.abierto_norte.wait_for(self.no_peaton)
    ...
    def wants_enter_pedestrian (self):
        ...
        self.abierto_peaton.wait_for(self.no_coches_sur) and self.abierto_peaton.wait_for(self.no_coches_norte)
        self.pedestrian.value-=1
