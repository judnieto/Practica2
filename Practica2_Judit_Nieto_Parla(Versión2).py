...
# VERSIÓN 2
# TURNO 0 PARA EL NORTE
# TURNO 1 PARA EL SUR
# TURNO 2 PARA LOS PEATONES
# TURNO -1 PARA QUIEN SEA
...
class Monitor():
    ...
    def adelante_coches_norte(self):
        return self.dentro_sur.value==0 and self.dentro_peaton.value==0 and (self.turno.value==0 or self.turno.value==-1)
    
    def adelante_coches_sur (self):
        return self.dentro_norte.value==0 and self.dentro_peaton.value==0 and (self.turno.value==1 or self.turno.value==-1)
    
    def adelante_peaton (self):
        return self.dentro_norte.value==0 and self.dentro_sur.value==0 and (self.turno.value==2 or self.turno.value==-1)
    ...
    def __repr__(self) -> str:
        return f'Monitor:{self.cars_north.value}, {self.cars_south.value},{self.pedestrian.value}'
